  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              We create innovative, scalable, and user-friendly applications
        ...
        {/* Bottom Bar */}
        <div
          className="mt-8 pt-8 border-t flex flex-col sm:flex-row justify-between items-center"
        ...
        >
          <p
            ...
            style={{ color: themeColors.foreground }}
          >
            © {currentYear} ex_code. All rights reserved.
          </p>
          <p
